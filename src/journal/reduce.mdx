...
tags:
  ...
  - reduce
date: 2022-11-28
imageSrc: '/assets/journal/reduce.jpg'
...
const folders = [ an `Array`, it means we must reduce it until we arrive at at an element that can be appended to the end of the array we are producing. The _initial_ value of our inner reduce call is the _current_ accumulator value.
